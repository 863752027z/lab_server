    ...
    for epoch in range(num_epochs):
        for i in range(len(loader_list)):
            ...
            for idx, (data, label) in enumerate(train_loader):
                ...
                temp_source = encoder_output[1:].view(seq-1, encoder_output.shape[1])    #seq-1*256
...
encoder_moudle_path = '/home/zlw/dataset/SAMM/moudle/encoder_moudle.pkl'
cell_moudle_path = '/home/zlw/dataset/SAMM/moudle/cell_moudle.pkl'
...
gen_train_feature(encoder_moudle, cell_moudle, path_list, save_path, 4)
