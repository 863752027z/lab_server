...
def gen_train_feature(encoder_moudle, cell_moudle, path_list, save_path, batch_size, num_workers):
    for i in range(len(path_list)):
        save_path = '/home/zlw/dataset/SAMM/train_feature' + '/' + path_list[i][35:] + '.xlsx'
        temp_loader = testLoader(path_list[i], batch_size, False, num_workers)
        feature = test(encoder_moudle, cell_moudle, temp_loader, batch_size)
...
encoder_modle_path = '/home/zlw/dataset/SAMM/moudle/encoder_modle.pkl'
cell_model_path = '/home/zlw/dataset/SAMM/moudle/cell_modle.pkl'
...
loss_list, encoder_model, cell_model = train(loader_list, learning_rate, num_epochs, batch_size)
