...
class LstmCell(nn.Module):
    def __init__(self):
        ...
        self.LstmCell = nn.LSTMCell(input_size=512, hidden_size=512)
...
def train(train_loader, learning_rate, num_epochs):
    ...
    for epoch in range(num_epochs):
        for idx, (data, label) in enumerate(train_loader):
            ...
            decoder_output = decoder_model(h.view(h.shape[0], 512, 1, 1))
...
def test(test_loader, encoder_model):
    for idx, (data, label) in enumerate(test_loader):
        ...
        encoder_output = encoder_output.view(encoder_output.shape[0], encoder_output.shape[1])
        if idx == 0:
            temp_feature = encoder_output
        else:
            temp_feature = torch.cat((temp_feature, encoder_output), 0)
...
batch_size = 4
learning_rate = 1e-3
file_path = '/home/zlw/dataset/s15_1/'
save_path = '/home/zlw/dataset/features2.xlsx'
encoder_modle_path = '/home/zlw/PycharmProjects/encoder_modle.pkl'
cell_model_path = '/home/zlw/PycharmProjects/cell_modle.pkl'
train_loader = trainLoader(file_path, batch_size, False, 8)
...
test_loader = testLoader(file_path, batch_size, False, 8)
feature = test(test_loader, load_encoder)
print('save features')
