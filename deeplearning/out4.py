...
def train(train_loader, learning_rate, num_epochs):
    ...
    for epoch in range(num_epochs):
        for idx, (data, label) in enumerate(train_loader):
            h = torch.zeros(3, 256).to(device)
            c = torch.zeros(3, 256).to(device)
...
batch_size = 4
learning_rate = 1e-3
train_path = '/home/zlw/dataset/s15_1/'
...
encoder_modle_path = '/home/zlw/PycharmProjects/encoder_modle256.pkl'
cell_model_path = '/home/zlw/PycharmProjects/cell_modle256.pkl'
